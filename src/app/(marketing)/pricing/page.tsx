        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            ...
            },
            {
              ...
              features: ["1× Premium Recycled PVC Smart Card", "NTAG213 NFC chip (100,000+ taps)", "Laser-engraved EcoTap professional branding", "Full sync with free Personal Dashboard"],
              cta: "Order Your Card",
              href: "/register",
              highlight: true,
            },
            {
              ...
              features: ["Custom-branded Recycled PVC cards (your logo & colors)", "Bulk deployment codes for instant setup", "Virgin-plastic-free manufacturing", "Volume: 20–99: $28 | 100–499: $25 | 500+: $22/card"],
            ...
            },
            {
              ...
              features: ["Exclusive territorial distribution rights", "Localized white-label sub-administration", "Tiered wholesale margins on Recycled PVC hardware", "Zero-waste baselines certification"],
